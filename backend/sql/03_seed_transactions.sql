...
INSERT INTO collectors (preferred_language, operating_location) VALUES
('hi', 'Whitefield, Bengaluru'),
('mr', 'Peenya, Bengaluru');
...
INSERT INTO transactions (lot_id, collector_id, material_category, quantity_weight_kg, quoted_price, final_price, recycler_id, collection_location, handover_location, txn_datetime, payment_status, transaction_status) VALUES
('LOT-2026-0001', 1, 'PCB', 3.5, 857.50, NULL, NULL, 'Whitefield, Bengaluru', NULL, '2026-08-01 09:20:00', 'pending', 'quoted'),
('LOT-2026-0002', 1, 'Battery', 2.0, 224.00, NULL, 3, 'Whitefield, Bengaluru', NULL, '2026-08-02 11:35:00', 'pending', 'matched'),
('LOT-2026-0003', 2, 'Cable', 8.0, 1800.00, 1780.00, 2, 'Peenya, Bengaluru', 'Peenya Industrial Area, Bengaluru', '2026-08-03 15:00:00', 'pending', 'handed_over'),
('LOT-2026-0004', 2, 'CRT', 12.0, 198.00, 195.00, 10, 'Peenya, Bengaluru', 'Hebbal, Bengaluru', '2026-08-04 12:00:00', 'paid', 'confirmed'),
('LOT-2026-0005', 1, 'Motor/Magnet Assembly', 1.5, 228.00, 225.00, 1, 'Whitefield, Bengaluru', 'Whitefield, Bengaluru', '2026-08-05 17:00:00', 'paid', 'confirmed'),
('LOT-2026-0006', 2, 'Mixed Plastic', 5.0, 72.50, 70.00, 6, 'Peenya, Bengaluru', 'Nandini Layout, Bengaluru', '2026-08-06 09:30:00', 'pending', 'handed_over');
