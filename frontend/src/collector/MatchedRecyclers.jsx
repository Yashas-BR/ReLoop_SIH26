      ...
      return (
        <div className="container">
          <div className="handover-success animate-scale-in" style={{ borderColor: 'var(--color-warning)', borderWidth: 2, borderStyle: 'solid' }}>
            ...
            <h1 className="section-title" style={{ textAlign: 'center' }}>Saved Offline</h1>
            <p className="section-subtitle" style={{ textAlign: 'center' }}>
              You're offline. The handover request for lot <strong>{lotId}</strong> to{' '}
              <strong>{handoverResult.recyclerName}</strong> has been saved locally and will
            ...
            <div className="handover-success__status-row" style={{ background: 'var(--color-warning-light)', borderRadius: 'var(--radius-md)', padding: 'var(--space-3)' }}>
              ...
              <span className="text-sm" style={{ color: 'var(--color-warning)', fontWeight: 'var(--weight-semibold)' }}>
                Pending sync — not yet confirmed by backend
              </span>
            </div>

            <p className="text-sm text-muted" style={{ textAlign: 'center', marginTop: 'var(--space-2)' }}>
              The reference number will be generated by the server after sync completes.
            </p>
